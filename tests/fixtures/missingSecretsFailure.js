...
exports.missingSecretsExpectedFix = exports.missingSecretsDiff = exports.missingSecretsYAML = exports.missingSecretsLog = void 0;
...
exports.missingSecretsDiff = `--- a/.github/workflows/deploy.yml
...
+#    - API_KEY
`;
exports.missingSecretsExpectedFix = `The workflow is missing environment variable mappings for required secrets. Add them to the Deploy step and configure them in repository settings.`;
