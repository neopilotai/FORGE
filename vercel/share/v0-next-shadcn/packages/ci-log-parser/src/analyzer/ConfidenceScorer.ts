...
export class ConfidenceScorer {
  ...
  static scoreFailure(
    event: FailureEvent,
    matchedRule?: ParseRule,
    contextQuality: number = 0.7
  ): ConfidenceMetrics {
    ...
    let suggestedAction: 'auto-fix' | 'manual-review' | 'escalate' = 'manual-review';
    if (score >= 0.9) {
   ...
   */
  static withContextBoost(
    metrics: ConfidenceMetrics,
    contextSignals: { [key: string]: boolean },
